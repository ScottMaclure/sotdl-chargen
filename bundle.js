...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sheet = __webpack_require__(327);

	var _Sheet2 = _interopRequireDefault(_Sheet);

	var _charGen = __webpack_require__(335);
	...
	var store = (0, _redux.createStore)(_charGen2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "f14fed788c819d8d7081526302017733.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainHeader = function MainHeader(_ref) {
	  var _ref$npm = _ref.npm;
	  var npm = _ref$npm === undefined ? defaultNpmData : _ref$npm;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _capitalize = __webpack_require__(203);

	var _capitalize2 = _interopRequireDefault(_capitalize);

	var _map = __webpack_require__(217);

	var _map2 = _interopRequireDefault(_map);

	var _ActionBar = __webpack_require__(318);
	...
	var _AdjustOne = __webpack_require__(322);
	...
	var renderAspects = function renderAspects(charAspects, ancestryAspects, changeValue) {
	  return (0, _map2.default)(charAspects, function (aspectVal, aspectKey) {
	    var capAspectKey = (0, _capitalize2.default)(aspectKey);
	    var aspect = ancestryAspects[aspectKey];

	    return _react2.default.createElement(
	      'div',
	      { key: aspectKey, className: 'row ' + aspectKey },
	      _react2.default.createElement(
	        'label',
	        { 'for': 'editAspect' + capAspectKey },
	        capAspectKey
	      ),
	      _react2.default.createElement(_Select2.default, { id: 'editAspect' + capAspectKey,
	        options: aspect.values, value: aspectVal,
	        onChange: function onChange(event) {
	          return changeValue('aspects.' + aspectKey, event.target.value);
	        }
	      })
	    );
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createCaseFirst = __webpack_require__(212);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var castSlice = __webpack_require__(213),
	    reHasComplexSymbol = __webpack_require__(215),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayMap = __webpack_require__(218),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(273),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getPrototype = __webpack_require__(274);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseHas = __webpack_require__(273),
	    ...
	    indexKeys = __webpack_require__(277),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArrayLikeObject = __webpack_require__(280);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isLength = __webpack_require__(284),
	    isObjectLike = __webpack_require__(210);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseForOwn = __webpack_require__(314),
	    createBaseEach = __webpack_require__(317);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionBar = function ActionBar(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(
	      'button',
	      { className: 'modeButton viewButton', onClick: onEdit, style: getViewStyle(mode) },
	      'View/Edit'
	    ),
	    _react2.default.createElement(
	      'button',
	      { className: 'modeButton editButton', onClick: onView, style: getEditStyle(mode) },
	      'Edit/View'
	    ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./actionBar.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./actionBar.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CharacterSheet = __webpack_require__(328);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isPopulatedArray = __webpack_require__(330);

	var _isPopulatedArray2 = _interopRequireDefault(_isPopulatedArray);

	var _Fieldset = __webpack_require__(331);

	var _Fieldset2 = _interopRequireDefault(_Fieldset);

	var _DisplayRow = __webpack_require__(332);
	...
	var renderSimpleObject = function renderSimpleObject(obj) {
	  return Object.keys(obj).map(function (key) {
	    return _react2.default.createElement(_DisplayRow2.default, { key: key, label: key, value: obj[key] });
	  });
	};
	...
	var CharacterSheet = function CharacterSheet(_ref) {
	  ...
	  return _react2.default.createElement(
	    ...
	    _react2.default.createElement(_Fieldset2.default, { legend: 'Info', content: _react2.default.createElement(
	        'div',
	        { className: 'content' },
	        _react2.default.createElement(_DisplayRow2.default, { key: 'name', label: 'Name', value: charData.name }),
	        _react2.default.createElement(_DisplayRow2.default, { key: 'level', label: 'Level', value: charData.level }),
	        _react2.default.createElement(_DisplayRow2.default, { key: 'ancestry', label: 'Ancestry', value: charData.ancestry }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	_app2.default.human = _human2.default; // Load all data needed for app and character.

	_app2.default.orc = _orc2.default;
...
/***/ function(module, exports) {
	...
	module.exports = {
		"title": "Shadow of the Demon Lord - Character Generator",
		"ancestries": [
			"Human",
			"Changeling (unsupported)",
			"Clockwork (unsupported)",
			"Dwarf (unsupported)",
			"Goblin (unsupported)",
			"Orc"
		],
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"attributes": {
			...
			"increaseOne": true,
			"notes": [
				"Choose one attribute and increase by 1."
			]
		},
		"characteristics": {
		...
		"talents": [
			"(1 extra language or profession)"
		],
		"aspects": {
			"age": {
				"dieRoll": "3d6",
				...
				"values": [
					{
						"min": 1,
						"max": 1,
						"value": "You died and returned to life. You start the game with [1d6] Insanity.",
						"effect": "insanity+1"
					},
					{
						"min": 2,
						"max": 2,
						"value": "You were briefly possessed by a demon. You start the game with 1 Corruption.",
						"effect": "corruption+1"
					},
					{
						"min": 3,
						"max": 3,
						"value": "You spent [1d6] years as a prisoner in a dungeon."
					},
					{
						"min": 4,
						"max": 4,
						"value": "You murdered someone in cold blood. You start the game with 1 Corruption.",
						"effect": "corruption+1"
					},
					{
						"min": 5,
						"max": 5,
						"value": "You caught and recovered from a terrible disease."
					},
					{
						"min": 6,
						"max": 6,
						"value": "You belonged to a strange cult and saw many strange things. You start the game with 1 Insanity.",
						"effect": "insanity+1"
					},
					{
						"min": 7,
						"max": 7,
						"value": "The faerie held you prisoner for [1d20] years."
					},
					{
						"min": 8,
						"max": 8,
						"value": "You lost a loved one and their loss haunts you still."
					},
					{
						"min": 9,
						"max": 9,
						"value": "You lost a finger, a few teeth, or an ear, or you gained a scar."
					},
					{
						"min": 10,
						"max": 10,
						"value": "You earned a living working in your profession."
					},
					{
						"min": 11,
						"max": 11,
						"value": "You fell in love and the relationship ended well or is ongoing."
					},
					{
						"min": 12,
						"max": 12,
						"value": "You have a spouse and [1d6-2] children (minimum 0)."
					},
					{
						"min": 13,
						"max": 13,
						"value": "You traveled extensively. You speak one additional language.",
						"effect": "languages+1"
					},
					{
						"min": 14,
						"max": 14,
						"value": "You received an education. You know how to read the Common Tongue.",
						"effect": "languages+Common Tongue"
					},
					{
						"min": 15,
						"max": 15,
						"value": "You saved your town from terrible monsters."
					},
					{
						"min": 16,
						"max": 16,
						"value": "You foiled a plot to kill someone important or you brought a killer to justice."
					},
					{
						"min": 17,
						"max": 17,
						"value": "You performed a great deed and are a hero to the people in your hometown."
					},
					{
						"min": 18,
						"max": 18,
						"value": "You found an old treasure map."
					},
					{
						"min": 19,
						"max": 19,
						"value": "Someone important and powerful owes you a favor."
					},
					{
						"min": 20,
						"max": 20,
				...
				"values": [
					{
						"min": 3,
						"max": 3,
						"value": "You belong to a cult dedicated to a dark power."
					},
					{
						"min": 4,
						"max": 4,
						"value": "You belong to a heretical sect."
					},
					{
						"min": 5,
						"max": 6,
						"value": "You were raised in the teachings of witchcraft."
					},
					{
						"min": 7,
						"max": 10,
						"value": "You follow the tenets of the Old Faith"
					},
					{
						"min": 11,
						"max": 15,
						"value": "You belong to the Cult of the New God."
					},
					{
						"min": 16,
						"max": 18,
			...
			"age": {
				...
				"values": [
					...
					},
					{
						"min": 4,
						"max": 7,
						"value": "You are an adolescent, 8 to 12 years old."
					},
					{
						"min": 8,
						"max": 12,
						"value": "You are a young adult, 13 to 18 years old."
					},
					{
						"min": 13,
						"max": 15,
						"value": "You are a middle-aged adult, 19 to 26 years old."
					},
					{
						"min": 16,
						"max": 17,
						"value": "You are an older adult, 27 to 32 years old."
					},
					{
						"min": 18,
						"max": 18,
						"value": "You are a venerable adult, 33 years old or older."
					}
				]
			},
			"build": {
				...
				"values": [
					{
						"min": 3,
						"max": 3,
						"value": "You are short and wiry."
					},
					{
						"min": 4,
						"max": 4,
						"value": "You are short and muscular."
					},
					{
						"min": 5,
						"max": 6,
					...
					},
					{
						"min": 9,
						"max": 12,
						"value": "You are of average height and weight."
					},
					{
						"min": 13,
						"max": 14,
						"value": "You are corpulent."
					},
					{
						"min": 15,
						"max": 16,
					...
					},
					{
						"min": 17,
						"max": 17,
						"value": "You are tall and gaunt."
					},
					{
						"min": 18,
						"max": 18,
						"value": "You are a giant among orcs."
					}
				]
			},
			"appearance": {
				...
				"values": [
					{
						"min": 3,
						"max": 5,
						"value": "You are grotesque. Your face is a mass of scar tissue. Thick scars crisscross your body, held together with crude, leather stitching. Swaths of open sores weep streams of pus, and you reek of excrement, blood, and rot."
					},
					{
						"min": 6,
						"max": 8,
						"value": "You are monstrous, with thick, brutish features, weird growths sprouting from your skin, and nasty scars that cut jagged lines across your thick hide."
					},
					{
						"min": 9,
						"max": 12,
						"value": "You are ugly. You have thick tusks jutting from your broad jaw, a sloping forehead, and tiny eyes set deep in your skull."
					},
					{
						"min": 13,
						"max": 15,
						"value": "You are an orc of typical appearance, dirty and unkempt."
					},
					{
						"min": 16,
						"max": 17,
						"value": "Your features are somewhat less brutish, though you might have odd skin coloration, extra fur, and thick features."
					},
					{
						"min": 18,
						"max": 18,
						"value": "You stand out from other orcs. Your body is remarkably free from the scars and injuries that maim your fellows, and you are in pretty good health"
					}
				]
			},
			"background": {
				...
				"values": [
					{
						"min": 1,
						"max": 1,
						"value": "You butchered helpless people. Gain 2 Corruption.",
						"effect": "corruption+2"
					},
					{
						"min": 2,
						"max": 2,
						"value": "You were briefly possessed by a demon. Gain 1 Corruption",
						"effect": "corruption+1"
					},
					{
						"min": 3,
						"max": 3,
						"value": "You spent [1d6] years in the fighting pit, testing your skills against other orcs for the amusement of the crowds."
					},
					{
						"min": 4,
						"max": 4,
						"value": "You stayed loyal to the Empire and fought against other orcs. You were branded as a traitor and cast out."
					},
					{
						"min": 5,
						"max": 5,
						"value": "You caught the rot and lost your nose and ears."
					},
					{
						"min": 6,
						"max": 6,
						"value": "You were chained to the oars in a slave ship for [1d6] years."
					},
					{
						"min": 7,
						"max": 7,
						"value": "You were made a eunuch and stood guard over the emperor’s concubines."
					},
					{
						"min": 8,
						"max": 8,
						"value": "You have scar tissue over half your body from when you were caught in the blast of a spell."
					},
					{
						"min": 9,
						"max": 9,
						"value": "You escaped your slavery and have lived in the wilderness ever since."
					},
					{
						"min": 10,
						"max": 10,
					...
					},
					{
						"min": 11,
						"max": 11,
						"value": "You fell in love with a human and were spurned for your affections."
					},
					{
						"min": 12,
						"max": 12,
						"value": "You sired or gave birth to [3d6] children. Roll [3d6] again and subtract that total from your total number of children to find out how many are still alive (minimum 0)."
					},
					{
						"min": 13,
						"max": 13,
					...
					},
					{
						...
						"max": 14,
						"value": "You received an education. You know how to read the Common Tongue.",
						"effect": "+readCommonTongue"
					},
					{
						"min": 15,
						"max": 15,
						"value": "You fought bravely for the Emperor and were awarded a medal for your courage."
					},
					{
						"min": 16,
						"max": 16,
						"value": "You saved an important noble from an assassination attempt."
					},
					{
						"min": 17,
						"max": 17,
						"value": "A human broke your chains and freed you to find your fortunes in the world."
					},
					{
						"min": 18,
						"max": 18,
						"value": "You took a sword from the corpse of a warrior you killed."
					},
					{
						"min": 19,
						"max": 19,
						"value": "The Gods of Blood and Iron visit you in your dreams. You start the game with 1 Insanity.",
						"effect": "insanity+1"
					},
					{
						"min": 20,
