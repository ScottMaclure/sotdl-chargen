...
const ActionBar = ({ mode, onEdit, onView, onCreate }) => (
	<div className="actionBar">
		<button className="modeButton" onClick={onEdit} style={getViewStyle(mode)}>View/Edit</button>
		<button className="modeButton" onClick={onView} style={getEditStyle(mode)}>Edit/View</button>
